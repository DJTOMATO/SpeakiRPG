...
#  -> [下載 / Download](https://github.com/DJTOMATO/SpeakiRPG/releases) | [加入 Discord](https://discord.gg/bruZhcwqRx) <- 
...
* **自訂聊天表情**: 這是一個完全互動式的自訂表情選擇面板，為你最喜歡的 Discord 風格表情提供巨大的懸停預覽。
...
- **[NEW]** HUD 背景圖片（隨斯皮奇等級 10 級至 50 級逐步解鎖）
- **[NEW]** 單次遊玩金幣與水晶葉收益追蹤器（即時追蹤本次遊戲連線期間獲得的貨幣）
...
- **[NEW]** 小遊戲追蹤與活動資訊 (追蹤每日剩餘遊玩次數與活動詳情)
- **[NEW]** 快捷鍵隱藏/顯示模組介面 (按 P 鍵切換所有模組覆蓋層顯示)
- **[NEW]** 官方更新公告簡報 (點擊 📰 按鈕在遊戲內查看自動翻譯的更新說明)
- **[NEW]** 本次遊玩與性能統計視窗 (點擊 ⏱️ 按鈕即時查看遊玩時長、每小時EXP、升級所需時間、金幣/水晶葉收益與網路延遲)
- **[NEW]** 快速登入與帳號管理器 (點擊 HUD 的 🔑 按鈕或按 F2 鍵開啟。支援復原代碼安全儲存、查看與複製；僅本機儲存絕不外流)
- **[NEW]** 更新與最新消息通知視窗 (在遊戲內即時獲取客戶端最新版本更新通知與日誌)
...
想一起協作開發嗎？歡迎加入我們的 [Discord 伺服器](https://discord.gg/bruZhcwqRx) 與我們聯絡，或在 GitHub 上 [發起 Pull Request](https://github.com/DJTOMATO/SpeakiRPG/pulls) 或 [提交 Issue 問題回報](https://github.com/DJTOMATO/SpeakiRPG/issues)！也非常歡迎繁體中文母語玩家協助修飾或校對文句！
